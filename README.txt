...
1.) Reads the list of cities into a string array using StdIn.readAllStrings() and then builds a symbol table where the key is the name of a city and the value is an integer.
2.) Reads the list of major cities into a string array using StdIn.readAllStrings().
3.) Creates an empty undirected graph using the class algs41.Graph. In this graph, each vertex represents a city.
